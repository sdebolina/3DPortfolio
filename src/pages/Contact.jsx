    ...
    emailjs
      .send(
        ...
        "template_urh4pgl",
        {
          ...
          to_email: 'photosonlyfor01@gmail.com',
          message: form.message,
        },
        "FemvTPLD5oREWyC8f" // Use an environment variable for security
      )
      .then(() => {
        setIsLoading(false);
        showAlert({
        ...
        <form ref={formRef} className="w-full flex flex-col gap-7 mt-14" onSubmit={handleSubmit}>
          ...
          <label className="text-black-500 font-semibold">
            ...
            <input
              ...
              name="email"
              className="input"
              placeholder="sdebolina1803@gmail.com"
              required
              value={form.email}
              onChange={handleChange}
              onFocus={handleFocus}
          ...
          <label className="text-black-500 font-semibold">
            ...
            <textarea
              name="message"
              className="input"
              placeholder="Let me know how I may help you"
              required
              value={form.message}
              onChange={handleChange}
              onFocus={handleFocus}
